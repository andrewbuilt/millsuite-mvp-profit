...
const POWERED_BY = [
  'Powered by steam. Just steam.',
  'Powered by Josh Hart',
  'Powered by space age polymers',
  'Powered by excessive garnishes',
  'Powered by organic diets',
  'Powered by rash decisions',
  'Powered by wayward dreams',
  'Powered by hamsters on wheels',
  'Powered by tracksuit friction',
  'Powered by liquid hot magma',
  'Powered by the snowball effect',
  'Powered by deafening silence',
  'Powered by utilitarianism',
  'Powered by Alaskan dog sleds',
  'Powered by autonomous rowboats',
  'Powered by drones shaped like jacked seagulls',
  'Powered by several biceps',
  'Powered by Mill-sweet',
  'Powered by Harry Potter magic',
  'Powered by electric fences',
  'Powered by a cotton headed ninnymuggins',
  'Powered by lusty youths',
  'Powered by vintage Porsches',
  'Powered by Sunday brunch',
  'Powered by exceptionally strong children',
  'Powered by misappropriated funds',
  'Powered by hot girl walks',
  "Powered by Elon Musk's ego",
  'Powered by political intrigue',
  'Powered by Daniel-san',
  'Powered by emerging markets',
  'Powered by honky-tonk-ba-donky-donks',
  'Powered by tremendous effort',
  'Powered by speed, power, flow',
  'Powered by the almighty git push',
  'Powered by cultural diversity',
  'Powered by photosynthesis',
  'Powered by spring showers',
  'Powered by sweaty wrestlers',
  'Powered by fresh table saw blades',
  'Powered by a long con',
  'Powered by a bird in the hand',
  'Powered by long, lonely nights',
  "Powered by a sailor's delight",
  'Powered by movers and shakers',
  'Powered by a mass exodus',
  'Powered by risky dance moves',
  "Powered by men of the Night's Watch",
  'Powered by erratic motions',
  'Powered by the smell of fresh cut grass',
  "Powered by your enemies' tears",
  'Powered by a firm handshake',
  'Powered by monarch migratory patterns',
  'Powered by whatever floats your boat',
  'Powered by strategic maneuvers',
  'Powered by Code Red Mountain Dew',
  'Powered by a well-balanced meal',
  'Powered by pour-over',
  'Powered by a flock of seagulls',
  'Powered by piss and vinegar',
  "Powered by your friend's boat",
  'Powered by well wishes',
  'Powered by our best intentions',
  'Powered by timeless style',
  'Powered by organic fertilizers',
  'Powered by hot, nasty, badass speed',
  'Powered by taller than average gymnasts',
  'Powered by firm and lingering handshakes',
  'Powered by an overfed sourdough starter',
  'Powered by Musclemilk White Russians',
]
